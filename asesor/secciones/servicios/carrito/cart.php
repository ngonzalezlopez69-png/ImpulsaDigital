...
<html>
	...
	<body>
		...
		<nav class="navbar">
			<div class="container">
				<a class="navbar-brand" href="../../../../index.php">Regresar a ImpulsaDigital</a>
		...
		<div class="container text-start">
			...
			<div class="col-md-5 col-sm-12">
				...
				<h2>Shopping cart</h2>
				<p>
					Carrito de compras gratuito y responsive de Tutorialzine. Se ve excelente en escritorio y móvil. Prueba cambiando el tamaño de la ventana o ábrelo en tu teléfono.
				</p>
			</div>
			...
			<div class="col-md-7 col-sm-12 text-left">
				<ul>
					...
					<li class="row">
						...
						<span class="itemName">Desarrollo solución</span>
						<span class="popbtn"><a class="arrow"></a></span>
						<span class="price">$6.300.000</span>
					</li>
					<li class="row">
						<span class="quantity">5</span>
						<span class="itemName">Pruebas QA</span>
